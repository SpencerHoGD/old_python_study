...
def insertOperate():
    ...
    df = pro.daily(trade_date='20210824')
    ...
    conn.close()
    print('insert {}th of {} records at {} into table "{}" successfully'.format(
        count, len(ts_code), trade_date[0], db))
...
def deleteOperate():
    ...
    cursor.execute("delete from {} where trade_date between \
        '2019-11-29 00:00:00' and '2021-11-29 23:59:59' ".format(db))
    conn.commit()
    print('end delete')
