...
class PdbModel:
    def __init__(self, host, dbname='postgres', username='postgres', password='394460', port='5432'):
        self.host = host
        self.dbname = dbname
...
if __name__ == '__main__':
    ...
    print(operator.eq(table_size_dic1, table_size_dic2))
    is_equal = operator.eq(table_size_dic1, table_size_dic2)
    ...
    if is_equal == 0:
        ...
        for key in keys1:
            ...
            if operator.eq(value1, value2) != 0:
