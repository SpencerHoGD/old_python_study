...
df = ts.pro_bar(ts_code='000002.SZ', adj='qfq',
                start_date='20100101', end_date='20191130')
...
df.loc[df['1d_close_future_pct'] == 0, '未来1d涨跌幅方向'] = '横盘'
df.loc[df['1d_close_future_pct'] < 0, '未来1d涨跌幅方向'] = '下跌'

df.loc[df['1d_close_pct'] > 0, '当前涨跌幅方向'] = 1    # 上涨记为1
# df.loc[df['1d_close_pct'] <= 0, '当前涨跌幅方向'] = 0    # 上涨记为0
df.loc[df['1d_close_pct'] == 0, '当前涨跌幅方向'] = 0    # 上涨记为0
df.loc[df['1d_close_pct'] < 0, '当前涨跌幅方向'] = -1    # 上涨记为-1
